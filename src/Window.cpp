...
GenericWindow::GenericWindow() : wxFrame(nullptr, wxID_ANY, "Remote Viewer", wxPoint(50, 50), wxSize(1270, 720)) {
	clientButton = new wxButton(this, wxID_ANY, "Client", wxPoint(200, 200), wxSize(300, 150));

	serverButton = new wxButton(this, wxID_ANY, "Server", wxPoint(600, 200), wxSize(300, 150));
}
